        ...
        <vx-card>
            ...
            <div class="demo-alignment mb-base">
                ...
                <vs-radio v-model="userRole" vs-value="admin">Admin</vs-radio>
                  <vs-radio v-model="userRole" vs-value="tester">Tester</vs-radio>
                  <vs-radio v-model="userRole" vs-value="superadmin">SuperAdmin</vs-radio>
            </div>
