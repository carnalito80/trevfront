            ...
            <table>
              ...
              <tr>
               ...
               <tr>
                ...
                <td>{{ user_data.email_verified_at || 'no' }}</td>
              </tr>
            </table>
          </div>
          <!-- /Information - Col 1 -->
          ...
          <div class="vx-col flex-1" id="account-info-col-2">
            <table>
              ...
              <tr>
                ...
                <td>{{ user_data.role.displayname }}</td>
              </tr>
              <tr>
                <td class="font-semibold">Company</td>
                <td>{{ user_data.company.name }}</td>
              </tr>
            </table>
          </div>
          <!-- /Information - Col 2 -->
          <div class="vx-col w-full flex" id="account-manage-buttons">
            <vs-button icon-pack="feather" icon="icon-edit" class="mr-4" :to="{name: 'admin-user-edit', params: { userId: $route.params.userId }}">Edit</vs-button>
  ...
  created () {
    ...
    this.$store.dispatch('userManagement/fetchUser', userId)
      .then(res => { 
        ...
        if (!this.user_data.avatar)  this.user_data.avatar =  process.env.VUE_APP_BACKEND_URL + process.env.VUE_APP_AVATAR_FOLDER + 'error.jpg';
        else this.user_data.avatar = process.env.VUE_APP_BACKEND_URL + process.env.VUE_APP_AVATAR_FOLDER + this.user_data.avatar;
        if  (this.user_data.company == null)  this.user_data.company = '';
