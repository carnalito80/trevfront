  ...
  <div id="user-edit-tab-info">
    ...
    <div class="vx-row">
      ...
      <div class="vx-col md:w-1/2 w-full">
        ...
        <vs-input class="w-full mt-4" label="Company ID" v-model="data_local.company_id" v-validate="'required|alpha_num'" name="company_id" />
...
export default {
  ...
  computed: {
    ...
    role_local: {
      get () {
         return { label: this.data_local.role.displayname,  value: this.data_local.role.name  }
        //return { label: this.capitalize(this.data_local.role.displayname),  value: this.data_local.role.name  }
      },
      set (obj) {
 ...
 .then(response => { 
    let thearray = []
          ...
          for (const key in response.data) {
            ...
            thearray.push({
              label: response.data[key].displayname,
              value: response.data[key].name })
          }
          console.log(thearray)
        this.roleOptions = thearray
   })
